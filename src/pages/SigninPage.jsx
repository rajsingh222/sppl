...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!consentData) {
      setIsError(true);
      setMessage("You must consent to data usage.");
      return;
    }

    try {
      // Adjust signupUser API call to include role as needed
        ...
        <form onSubmit={handleSubmit}>
          <VStack spacing={4}>
            ...
            <FormControl isRequired>
              ...
              <VStack spacing={1} align="start">
                <PasswordCriteria isValid={passwordValidity.minLength} label="At least 8 characters" />
                <PasswordCriteria isValid={passwordValidity.hasLower} label="1 lowercase letter" />
                <PasswordCriteria isValid={passwordValidity.hasUpper} label="1 uppercase letter" />
                <PasswordCriteria isValid={passwordValidity.hasNumber} label="1 number" />
                <PasswordCriteria isValid={passwordValidity.hasSymbol} label="1 special symbol" />
              </VStack>
            </FormControl>
            <FormControl isRequired>
              <FormLabel>Confirm Password</FormLabel>
